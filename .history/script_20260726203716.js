...
function drawConnections(canvas, svg) {
  ...
  const traverse = (person) => {
    ...
    person.children.forEach((child) => {
      ...
      const parentX = parentPosition.x + 240 + viewOffset.x;
      const parentY = parentPosition.y + 80 + viewOffset.y;
      const childX = childPosition.x - 12 + viewOffset.x;
      const childY = childPosition.y + 80 + viewOffset.y;
